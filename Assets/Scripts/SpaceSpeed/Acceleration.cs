...
public class Acceleration : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //This is also the reciver of everything that have something to do with acceleration.
            ...
            {
                accelerationX = ShipController.ShipAccelerationX + gravity1.GravitationelAccellerationFinished[0] + player1.AccelerationPlayer[0];
                accelerationY = ShipController.ShipAccelerationY + gravity1.GravitationelAccellerationFinished[1] + player1.AccelerationPlayer[1];
                accelerationZ = ShipController.ShipAccelerationZ + gravity1.GravitationelAccellerationFinished[2] + player1.AccelerationPlayer[2];
